...
**Всё, что нужно для работы, лежит в одной самодостаточной методичке:**

- [`docs/metodichka/методичка_подробная.md`](docs/metodichka/методичка_подробная.md) — полный текст с теорией, полными листингами всех скриптов и заданиями.
- [`docs/metodichka/Методичка_подробная.docx`](docs/metodichka/Методичка_подробная.docx) — та же методичка в DOCX (для печати / сдачи).
